...
from app.portability.registry import PORTABLE_V4_MANIFEST
...
async def test_portable_v4_manifest_and_tampered_analysis_hash_rejection(
    ...
    assert package["payload"]["manifest"] == PORTABLE_V4_MANIFEST
