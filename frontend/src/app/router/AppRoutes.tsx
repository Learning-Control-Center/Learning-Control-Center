...
export function AppRoutes() {
  return <Routes><Route element={<ApplicationShell />}><Route index element={<AuthoritySurface surface="today" />} /><Route path="roadmap" element={<AuthoritySurface surface="roadmap" />} /><Route path="profile" element={<LazySurface><Profile /></LazySurface>} /><Route path="profile/competencies/:competencyIdentityId" element={<CompatibilityRedirect to={paths.profile} />} /><Route path="learn" element={<LazySurface><Learn /></LazySurface>} /><Route path="learn/curricula/:curriculumId" element={<CompatibilityRedirect to={paths.learn} />} /><Route path="projects" element={<LazySurface><Projects /></LazySurface>} /><Route path="projects/:projectId" element={<CompatibilityRedirect to={paths.projects} />} /><Route path="activity" element={<LazySurface><Activity /></LazySurface>} /><Route path="insights" element={<LazySurface><InsightsIndex /></LazySurface>} /><Route path="insights/analysis" element={<LazySurface><Analysis /></LazySurface>} /><Route path="insights/recommendations" element={<AuthoritySurface surface="recommendation" />} /><Route path="insights/legacy" element={<LazySurface><LegacyIndex /></LazySurface>} /><Route path="insights/legacy/today" element={<LazySurface><LegacyToday /></LazySurface>} /><Route path="insights/legacy/roadmap" element={<LazySurface><LegacyRoadmap /></LazySurface>} /><Route path="insights/legacy/analytics" element={<LazySurface><LegacyAnalytics /></LazySurface>} /><Route path="insights/legacy/reports" element={<LazySurface><LegacyReports /></LazySurface>} /><Route path="data-transfer" element={<LazySurface><DataTransfer /></LazySurface>} /><Route path="settings" element={<LazySurface><Settings /></LazySurface>} />
  {compatibilityAliases.map((alias) => <Route key={alias.from} path={alias.from.slice(1)} element={<CompatibilityRedirect to={alias.to} />} />)}<Route path="*" element={<Navigate to={paths.today} replace />} /></Route></Routes>
}
